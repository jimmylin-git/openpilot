...
GROUND_GRID_SPACING_M = 0.75
GROUND_GRID_LATERAL_SPACING_M = 0.125
GROUND_GRID_LINE_WIDTH_M = 0.045
...
GROUND_GRID_DAY_ALPHA = 90
GROUND_GRID_NIGHT_ALPHA = 130
...
def build_cluster_scene(
    ...
    if SCENE_BUILD_ISOLATION_STAGE == "ego_vehicle":
        profile_stage = profile_scene_start(profile_add)
        scene = ClusterScene(
            camera=camera,
            scene_shift_x_m=scene_shift_x_m,
        ...
        profile_scene_add(profile_add, "scene.build.pack_ego_vehicle", profile_stage)
        return scene
